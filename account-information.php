                        ...
                        <div class="table-content wnro__table table-responsive">
                            <table>
                                ...
                                <tbody>
                                    ...
                                    $qryord=mysqli_query($conn,"SELECT * FROM orders WHERE  user_id='$_SESSION[user_id]' AND order_status!='failed' AND payment_status!='failed' AND payment_status!='' AND date > DATE_SUB(now(), INTERVAL 6 MONTH) ORDER BY id DESC"); 
