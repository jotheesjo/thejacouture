...
?>
  ...
  <td class="sorting_1"><button class="btn btn-info btn-sm" data-toggle="modal" data-target=".trackedit<?php echo $orderlist['id']; ?>" <?php if($orderlist['delivery_status']!=''){ ?>disabled <?php } ?>> <i class="fa fa-pencil"></i></button>
 ...
 <div class="modal fade trackedit<?php echo $orderlist['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
													...
													<div class="col-md-6">
													<label style="display:block;">NEFT/RTGS No</label>
													<input type="text" name="neftref" class="form-control" value="<?=$orderlist['neft_ref_no'];?>">
													</div>
													<div class="col-md-6">
													<label style="display:block;">NEFT/RTGS Date</label>
													<input type="date" name="neftrefdate" class="form-control" value="<?=$orderlist['neft_ref_date'];?>">
													</div>														
													<div class="col-md-6">
													<label style="display:block;">Status</label>
													<select name="delivery_status" class="form-control" required>
													<option disabled selected value>Select Status</option>
													<option value="Packing" <?php if($orderlist['delivery_status']=='Packing'){?> selected <?php } ?>>Move to Pack</option>
													</select>
													</div>
													</div>
													</div>
...
<?php if(isset($_POST['courier_update'])){
    ...
    window.location.href='customer_proforma.php';
    </SCRIPT>");
