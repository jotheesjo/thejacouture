                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Add Size</h3>
                                </div>
								...
								<?php if(isset($_GET['msg'])){ ?> 
                                    ...
                                    <form class="" action="insert.php" method="POST" enctype="multipart/form-data" novalidate="">                         <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                   ...
                                                   <textarea  class="form-control" name="size_desc" required=""> </textarea>
                                                </div>
                                                <div class="form-group">
                                                   <div>
                                                        <button type="submit"   name="add_size" class="btn btn-primary waves-effect waves-light">
                                                           Submit
                                                        </button>
                                                    </div>
                                               </div>
