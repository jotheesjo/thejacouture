...
<thead>
                                                ...
                                                <tbody> 
<?php $row=$db->query("SELECT * FROM vendor_proforma_payment_approve where payment_status='paid' AND (type='' OR type='proforma')");
$ven_order=array();
...
<?php } ?> 
					...
					<td>	<a href="view_proforma_material_status.php?getid=<?php echo $orderid; ?>"> <button class="btn btn-default btn-sm">View</button></a></td>							 
