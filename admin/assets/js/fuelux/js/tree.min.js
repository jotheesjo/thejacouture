        ...
        populate: function(e) {
            ...
            r.show(), this.options.dataSource.data(e.data(), function(o) {
                r.hide(), t.each(o.data, function(r, o) {
                    var s;
                    "folder" === o.type ? (s = i.$element.find(".tree-folder:eq(0)").clone().show(), s.find(".tree-folder-name").php(o.name), s.find(".tree-loader").php(i.options.loadingHTML), s.find(".tree-folder-header").data(o)) : "item" === o.type && (s = i.$element.find(".tree-item:eq(0)").clone().show(), s.find(".tree-item-name").php(o.name), s.data(o));
