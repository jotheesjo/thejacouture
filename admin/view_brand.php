...
<div class="main">
            ...
            <div class="main-content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <!-- BASIC TABLE -->
                            <a href="add_brand.php" class="btn btn-info">Add Brand</a>
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <?php } ?>
    <?php $count = $db->query("select * from variation_brand");
        if (mysqli_num_rows($count) != 0)
  {
    ?>
                                   <table id="datatable" class="table responsive-data-table  dataTable "  role="grid" aria-describedby="datatable_info">
                                                ...
                                                <tbody>
                                                <?php $variation = $db->query("select * from variation_brand");
                                                    $i=1;
            ...
            ?> 
                                                ...
                                                <tr role="row" class="odd" <?php if($ro['status']=='0'){ echo 'style="background-color:#cccccc"'; } ?>>
                                                          <td><?php  echo $i++; ?> </td>
                                                    <td class="sorting_1"><?php echo $ro['brand_name']; ?></td>
                                                   
                                                    <td><?php echo $ro['brand_desc']; ?></td>
                                                    <td><?php if($ro['status']=='1'){ echo 'Active';}else{
                                                        echo "Inactive"; } ?></td>
                                                    <td><a href="edit_brand.php?catid=<?php echo $ro[0]; ?>"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></button> </a>
 ...
 <div class="modal fade edit<?php echo $ro[0]; ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-md">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title mt-0" id="mySmallModalLabel">Delete <?php echo $ro[1]; ?> Brand variation</h5>
                                                        ...
                                                        <input type="hidden" name="brand_id" value="<?php echo $ro[0]; ?>"> 
                                                            <button type="submit"  name="delete_brand" class="btn btn-primary">Yes</button>
