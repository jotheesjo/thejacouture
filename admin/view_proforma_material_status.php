...
<!-- modal -->
 <div class="modal fade orderedit<?php echo $orderid; ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-md">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title mt-0" id="mySmallModalLabel">Add Shipping</h5>
												...
												<div class="col-xs-6">
													...
													<label>Shipping Provider Name</label>
													  <input type="text" name="shipprovider" value="" class="form-control"> 
                                                </div>
												</div>
												<div class="col-xs-6">
                                                    <div class="form-group">
													<label>To Pay Cost</label>
													  <input type="text" name="topaycost" value="" class="form-control"> 
                                                </div>
												</div>
												<div class="col-xs-6">
                                                    <div class="form-group">
													<label>Tracking Number</label>
													  <input type="text" name="tracknumber" value="" class="form-control"> 
                                                </div>
												</div>
												<div class="col-xs-6">
                                                    <div class="form-group">
													<label>Mode</label>
													  <input type="text" name="mode" value="" class="form-control"> 
                                                </div>
												</div>
												<div class="col-xs-6">
                                                    <div class="form-group">
													<label>Date Shipped</label>
													  <input type="date" name="dateshipped" value="" class="form-control"> 
                                                </div>
												</div>
												<div class="col-xs-6">
                                                    <div class="form-group">
													<label>Estd.delivery</label>
													  <input type="date" name="estddelivery" value="<?php echo $orderid; ?>" class="form-control"> 
                                                </div>
												</div>
                                                  </div>
...
<button class="btn btn-info btn-sm" data-toggle="modal" data-target=".orderedit<?php echo $orderid; ?>"> <i class="fa fa-pencil"></i></button>
<div class="panel">
