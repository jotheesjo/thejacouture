...
<?php } ?>
                               ...
                               <div class="single-contact-form">
                                ...
                                <div class="single-contact-form">
        <textarea class="form-control" name="shipping_information" placeholder="Notes"></textarea>
    </div>
                            ...
                            <div class="create__account">
                                <div class="wn__accountbox">
                                    <input class="input-checkbox" name="createaccount" value="acc_create" type="checkbox">
                        ...
                        <div class="customer_details mt--20">
                            <div class="">
                                <input name="ship_to_different_address" value="diff_ship" type="checkbox" class="ship_diff differt__address">
                                <span style="color: #141412;font-size: 14px;font-weight: 700;margin-left: 8px;">Ship to a different address ?</span>
                            </div>
                            <div class="customar__field differt__form mt--40">
                                ...
                                <div class="single-contact-form space-between">
                                 ...
                                 <div class="single-contact-form space-between">
                                     <input type="text" name="smobile" placeholder="Mobile Number*" pattern="\d*">
                                      <input type="text" name="saltr_mobile" placeholder="Alternate Mobile Number*" pattern="\d*">
                                </div>
                                <div class="single-contact-form">
                                    <input type="text" name="saddr1" placeholder="Flat, House no., Building, Company, Apartment*" >
                                </div>
                                <div class="single-contact-form">
                                    <input type="text" name="saddr2" placeholder="Area, Colony, Street, Sector, Village*" >
                                </div>
                                <div class="single-contact-form">
                                    <input type="text" name="saddr3" placeholder="Landmark e.g. near apollo hospital*" >
                                </div>
                                <div class="single-contact-form">
                                    <input type="text" name="scity" placeholder="City*" >
                                </div>
                               <div class="single-contact-form">
                                    <input type="text" name="sstate" placeholder="State*" >
                                </div>
                                <div class="single-contact-form">
                                    <input type="text" name="scountry" placeholder="Country*" >
                                </div>
                                <div class="single-contact-form">
                                    <input type="text" name="spincode" placeholder="Pincode*" pattern="\d*">
                                </div>
                                        ...
                                        foreach ($_SESSION['cart'] as $key => $value) {
                                            ...
                                            while($cart_row= mysqli_fetch_assoc($cart_qry)){
                                                ...
                                                ?>
                                                    ...
                                                    <li>
                                                        <img class="img-fluid" src="<?=$imm[0];?>" style="width: 85px;float: left;padding: 0px 15px 0px 0px;"/>
...
<script>
                $("#valid_coupon").click(function(){
                    ...
                    var subtotal=$("#grant_val").html();
                    if(a!=''){
                     $.ajax({
                        type:'POST',
                        url:'ajax-cart.php',
                        data:'coupon='+a+'&status=apply_coupon'+'&subtotal='+subtotal,
                        success:function(data){
