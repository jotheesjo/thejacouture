...
$pay_response=json_encode($_POST,true);
	mysqli_query($conn, "UPDATE orders SET payment_status='success',txn_id='$_POST[razorpay_payment_id]',order_status='Processing', payment_gateway_response='$pay_response' WHERE order_id='$_POST[shopping_order_id]'");
    //update qty
    $myorder_data=mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM orders WHERE order_id='$_POST[shopping_order_id]'"));
